      ...
      messages: [
        {
          role: "system",
          content:
            "You create concise JSON chart specs for Recharts with keys: charts (array). Each chart has id, type (line|bar|area|pie), title, description, data (array of objects), xKey, yKeys (array of {key,label}), categoryKey, valueKey. Only include data you can derive from the provided context and keep datasets small (<=8 rows).",
        },
        {
          role: "user",
